...
export default function AssistenteIA({
  ...
  const [mensagens, setMensagens] = useState<Mensagem[]>([
    {
      role: 'assistant',
      content: 'Olá! Sou o assistente de vendas PILI. Como posso ajudá-lo hoje?',
      timestamp: new Date(),
    },
  ]);
  ...
  if (isMinimized) {
    return (
      <div
        className="fixed bottom-4 right-4 bg-red-600 text-white p-4 rounded-full shadow-lg cursor-pointer hover:bg-red-700 transition-colors z-50"
    ...
    <div className="fixed bottom-4 right-4 w-96 h-[500px] bg-white rounded-lg shadow-2xl flex flex-col z-50 border border-gray-200">
      ...
      <div className="bg-red-600 text-white p-3 rounded-t-lg flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold">Assistente PILI</span>
        </div>
