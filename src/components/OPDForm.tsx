  ...
  useEffect(() => {
    if (opd) {
      setFormData({
        ...
        data_entrega: opd.data_entrega ? opd.data_entrega.split('T')[0] : '',
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          placeholder="Ex: LAR - UNIDADE RAMILANDIA"
        />
      </div>
      ...
      <div className="p-4 bg-gradient-to-r from-green-50 to-green-100 border-2 border-green-300 rounded-lg">
        <label htmlFor="data_entrega" className="block text-sm font-bold text-green-900 mb-2">
          📅 Previsão de Entrega (IMPORTANTE)
        </label>
        <input
          type="date"
          id="data_entrega"
          ...
          onChange={handleChange}
          className="w-full px-3 py-2 border-2 border-green-400 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white text-lg font-semibold"
        />
      </div>
