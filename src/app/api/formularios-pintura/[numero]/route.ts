...
export async function POST(
  ...
  try {
    ...
    const existingResult = await client.query(`
      ...
      WHERE atividade_id = $1 AND tipo_formulario = 'CONTROLE_QUALIDADE_PINTURA'
      LIMIT 1
    `, [atividade_id]);
    ...
    console.error('Erro ao salvar formulário Pintura:', error);
...
export async function GET(
  ...
  try {
    ...
    console.error('Erro ao buscar formulário Pintura:', error);
