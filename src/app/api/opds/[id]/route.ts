  ...
  try {
    ...
    if (datasAlteradas.length > 0) {
      ...
      const atividadesProducao = [
        'PRODUÇÃO',
        // Subtarefas TOMBADOR (21 etapas: A - U)
        'A - CORTE',
        'B - MONTAGEM SUPERIOR E ESQUADRO',
        'C - CENTRAL HIDRÁULICA (SETOR HIDRÁULICA)',
        'D - SOLDA LADO 01',
        'E - SOLDA LADO 02',
        'F - MONTAGEM E SOLDA INFERIOR',
        'G - MONTAGEM ELÉTRICA/HIDRÁULICO',
        'H - MONTAGEM DAS CALHAS',
        'I - TRAVADOR DE RODAS LATERAL MÓVEL',
        'J - CAIXA DO TRAVA CHASSI',
        'K - TRAVA CHASSI',
        'L - CAVALETE DO TRAVA CHASSI',
