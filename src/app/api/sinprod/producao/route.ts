    ...
    const [
      ...
      sinprodQuery(`
        SELECT FIRST 20 t.DT_LEITURA_INI, t.DT_LEITURA_FIM,
          ...
          t.CD_RECURSO, gp.DESCRICAO as NOME_RECURSO,
          t.ORDEM_FABRICACAO, t.CD_PROCESSO, p.NOME as NOME_PROCESSO,
          t.HORAS_COMPUTADAS, t.QTDE_PRODUZIDA, t.QTDE_REFUGADA, t.CD_PARADA
        FROM TEMPOS_PRODUCAO_LEITORES t
