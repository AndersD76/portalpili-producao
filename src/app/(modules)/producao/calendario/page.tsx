        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Calendário de Entregas</h1>
                <p className="text-gray-600 mt-1 text-sm">Visualização de datas de entrega das OPDs</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-2">
              ...
              <Link
                href="/"
                className="flex-1 sm:flex-none px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition text-center text-sm"
              >
                Módulos
              </Link>
            </div>
