    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-red-700 text-white px-4 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <span className="bg-red-600 px-2 py-0.5 rounded text-xs">{expenses.length} pendentes</span>
        </div>
              ...
              <div className="flex gap-3 p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2 text-[10px]">
                    ...
                    {e.osv_number && <span className="px-2 py-0.5 bg-red-50 text-red-600 rounded">OSV: {e.osv_number}</span>}
              ...
              {editingId === e.id && (
                <div className="bg-gray-50 px-4 py-3 border-t grid grid-cols-2 sm:grid-cols-4 gap-2">
                  ...
                  <div className="col-span-2 sm:col-span-4 flex justify-end gap-2">
                    ...
                    <button onClick={() => saveEdit(e.id)} className="px-3 py-1 bg-red-600 text-white rounded text-sm hover:bg-red-700">Salvar</button>
                  </div>
                </div>
              )}
